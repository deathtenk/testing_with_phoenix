defmodule TestingWithPhoenix.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import TestingWithPhoenix.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&TestingWithPhoenix.ErrorHelpers.translate_error/1)
